...
export default function Hero() {
  return (
    <section className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-4 sm:px-6 pt-2 sm:pt-10 pb-12 sm:pb-24 -translate-y-16 sm:-translate-y-10 md:-translate-y-14 select-none">
